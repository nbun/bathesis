...
module FlatCurry.ShowCoq(showFlatProg,showFlatType,showFlatFunc,
...
showFlatLit (Charc  c) = "(Charc \"" ++ doubleToSingleQuote (filter (/='\'') (show c)) ++ "\")"

doubleToSingleQuote [] = []
doubleToSingleQuote (c:s) = case c of
                             '"' -> ['\'']
                             otherwise -> [c] ++ doubleToSingleQuote s
