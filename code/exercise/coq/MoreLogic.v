...
Proof. 
  intros. unfold not. intros. inversion H0. apply H1. apply H. Qed.
...
Proof.
   intros. split. intros.
   inversion H. inversion H0. left. exists witness. apply H1.
   right. exists witness. apply H1.
   intros. inversion H. inversion H0. exists witness. left. apply H1.
   inversion H0. exists witness. right. apply H1. Qed.
(** [] *)
...
Proof.
  intros. unfold override'. destruct (eq_nat_dec k1 k2). reflexivity.
  reflexivity. Qed.
(** [] *)
