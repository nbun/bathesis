...
Theorem iff_trans : forall P Q R : Prop, 
  (P <-> Q) -> (Q <-> R) -> (P <-> R).
Proof.
  intros. inversion H. inversion H0. split. intros. 
  apply H1 in H5. apply H3 in H5. apply H5.
...
Theorem or_distributes_over_and_2 : forall P Q R : Prop,
  (P \/ Q) /\ (P \/ R) -> P \/ (Q /\ R).
Proof.
  intros. destruct H as [[HL | HR] [HL' | HR']].
  left. apply HL.
  left. apply HL.
  left. apply HL'.
  right. split. apply HR. apply HR'.
Qed.
...
Proof.
  intros. split. intros. 
  inversion H. split. left. apply H0. left. apply H0.
  inversion H0. split. right. apply H1. right. apply H2.
  intros. apply or_distributes_over_and_2. apply H.
Qed.
(** [] *)
