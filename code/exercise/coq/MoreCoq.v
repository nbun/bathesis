...
Proof.
  intros n. induction n as [| n'].
    (* Hint: use the plus_n_Sm lemma *)
     intros. induction m as [|m']. reflexivity. simpl in H. inversion H.
     intros. induction m as [|m']. rewrite <- plus_n_Sm in H. inversion H.
     inversion H. rewrite <- plus_n_Sm in H1. rewrite <- plus_n_Sm in H1. 
     inversion H1. apply IHn' in H2. rewrite H2. reflexivity. 
Qed.
...
Proof.
  ...
  intros m H. destruct m. inversion H. inversion H. apply f_equal. apply    IHn'. apply H1. 
Qed.
...
Proof.
  intro n. induction n.
  intros X l H. destruct l. reflexivity. inversion H. 
  intros X l H. destruct l. reflexivity. inversion H. simpl. rewrite -> H1.
  apply IHn. apply H1.
Qed.
(** [] *)
...
Proof.
  intros. unfold override. destruct (beq_nat k1 k2). reflexivity. apply f_equal. reflexivity.
Qed.
(** [] *)
...
Theorem bool_fn_applied_thrice : 
  ...
  f (f (f b)) = f b.
Proof.
  intros. destruct b. destruct (f true) eqn:H. rewrite H. rewrite H. reflexivity.
  destruct (f false) eqn:H1. rewrite H. reflexivity.
  rewrite H1. reflexivity.
  destruct (f false) eqn:H. 
  destruct (f true) eqn:H1. rewrite H1. reflexivity. rewrite H. reflexivity. rewrite H. rewrite H. reflexivity. Qed.
(** [] *)
