...
Qed.
\end{coqcode}
The first subgoal is easily proven by using \texttt{reflexivity}.
\begin{coqcode}
...
\begin{coqcode}
Definition example3a : cntxt |- exp3 \in Int.
Proof.
  eapply T_Free.
  eapply T_Case.
  Show Existentials.
    * repeat econstructor. 
      ...
      instantiate (1 := [Int]). repeat econstructor.
    * repeat econstructor.
    * repeat econstructor.
Qed.
\end{coqcode}
