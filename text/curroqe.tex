\documentclass[fleqn, abstract=on, twoside]{scrreprt}
% escapeinside
...
\todo{Introductions are hard...}
This thesis is structured the following way: We begin with the preliminaries in \autoref{preliminiaries}.  Besides a basic introduction to Curry and Coq, this chapter gives a theoretical overview of the following chapters \ref{cumin} and \ref{flatcurry}. These chapters discuss two representations of Curry code, formal typing rules and a Coq implementation of the type system. Chapter \ref{cumin} ends with a few examples and a section about automated proofs, while \autoref{flatcurry} is finished with a program that transforms Curry programs into a Coq-compatible form. The last chapter presents results and possible expansions thereof. 
