\documentclass[paper = a4, fleqn, twoside]{scrreprt}
% escapeinside
...
The complete process of transforming a Curry file begins with compiling the program and using \texttt{showFlatCoq} to generate the definition and \coqinline{_CoqProject} files.
\begin{minted}{bash}
